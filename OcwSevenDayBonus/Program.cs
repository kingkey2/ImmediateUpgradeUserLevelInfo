...
namespace OcwPHImmediateUpgradeUserLevelInfo {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            iQueryThread = new System.Threading.Thread(QueryThread_Monitor);
            iQueryThread.Start();
        ...
        static void QueryThread_Loop() {
            ...
            while (true) {
                ...
                ret = MgmtAPI.ImmediateUpgradeUserLevelInfo(hash);

                if (ret != null) {
                    if (ret.Result == OcwPHImmediateUpgradeUserLevelInfo.MgmtAPI.enumResult.OK) {
                        Console.WriteLine("SearchDate:" + dateTime);
                    } else {
